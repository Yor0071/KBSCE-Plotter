...
################################################################
# This is a generated script based on design: RISC_V
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    CONFIG.Coe_File {c:/Users/liamb/GitHub/KBSCE-Plotter/Vivado/KBSCE-Plotter.srcs/sources_1/ip/framebuffer/framebuffer_tptilewv.coe} \
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins axi_gpio_switches/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_1_VGA_PCLK  [get_bd_pins clk_wiz_1/VGA_PCLK] \
