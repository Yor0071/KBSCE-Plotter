...
--               /home/maartenvk/src/KBSCE-Plotter/Vivado/KBSCE-Plotter.gen/sources_1/bd/RISC_V/ip/RISC_V_BRAMMux_0_0/RISC_V_BRAMMux_0_0_sim_netlist.vhdl
-- Design      : RISC_V_BRAMMux_0_0
...
entity RISC_V_BRAMMux_0_0_BRAMMux is
  port (
  ...
  attribute ORIG_REF_NAME of RISC_V_BRAMMux_0_0_BRAMMux : entity is "BRAMMux";
end RISC_V_BRAMMux_0_0_BRAMMux;

architecture STRUCTURE of RISC_V_BRAMMux_0_0_BRAMMux is
...
entity RISC_V_BRAMMux_0_0 is
  ...
  attribute NotValidForBitStream of RISC_V_BRAMMux_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of RISC_V_BRAMMux_0_0 : entity is "RISC_V_BRAMMux_0_0,BRAMMux,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of RISC_V_BRAMMux_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of RISC_V_BRAMMux_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of RISC_V_BRAMMux_0_0 : entity is "BRAMMux,Vivado 2025.1";
end RISC_V_BRAMMux_0_0;

architecture STRUCTURE of RISC_V_BRAMMux_0_0 is
  ...
  attribute x_interface_parameter of s_in_camera_en : signal is "XIL_INTERFACENAME BRAM_IN_PORT_CAMERA, MASTER_TYPE OTHER, MEM_SIZE 8192, MEM_WIDTH 32, MEM_ECC NONE, READ_LATENCY 2";
  ...
  attribute x_interface_parameter of s_in_microblaze_en : signal is "XIL_INTERFACENAME BRAM_IN_PORT_MICROBLAZE, MASTER_TYPE OTHER, MEM_SIZE 8192, MEM_WIDTH 32, MEM_ECC NONE, READ_LATENCY 1";
  ...
  attribute x_interface_parameter of s_out_fb_en : signal is "XIL_INTERFACENAME BRAM_OUT_PORT_FB, MASTER_TYPE OTHER, MEM_SIZE 8192, MEM_WIDTH 32, MEM_ECC NONE, READ_LATENCY 1";
...
s_out_fb_en_INST_0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\s_out_fb_we[0]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => s_in_camera_we(0),
      I1 => s_in_microblaze_we(0),
      O => s_out_fb_we(0)
    );
end STRUCTURE;
