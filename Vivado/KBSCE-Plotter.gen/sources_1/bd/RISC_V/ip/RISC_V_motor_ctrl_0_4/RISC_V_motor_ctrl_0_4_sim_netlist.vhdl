...
architecture STRUCTURE of RISC_V_motor_ctrl_0_4_motor_ctrl is
  component RISC_V_motor_ctrl_0_4_MotorControl is
  port (
    clk : in STD_LOGIC;
    resetn : in STD_LOGIC;
  ...
  end component RISC_V_motor_ctrl_0_4_MotorControl;
  component RISC_V_motor_ctrl_0_4_MotorControl_HD1 is
  port (
    clk : in STD_LOGIC;
    dir : in STD_LOGIC;
    in1 : out STD_LOGIC;
  ...
  end component RISC_V_motor_ctrl_0_4_MotorControl_HD1;
...
u_m1: component RISC_V_motor_ctrl_0_4_MotorControl
     port map (
      clk => s00_axi_aclk,
      dir => reg_x1_ctrl(8),
      in1 => m1_in1,
...
u_m2: component RISC_V_motor_ctrl_0_4_MotorControl
     port map (
      clk => s00_axi_aclk,
      dir => reg_x2_ctrl(8),
      in1 => m2_in1,
...
u_m3: component RISC_V_motor_ctrl_0_4_MotorControl
     port map (
      clk => s00_axi_aclk,
      dir => reg_y_ctrl(8),
      in1 => m3_in1,
...
u_m4: component RISC_V_motor_ctrl_0_4_MotorControl_HD1
     port map (
      clk => s00_axi_aclk,
      dir => reg_z_ctrl(8),
      in1 => m4_in1,
