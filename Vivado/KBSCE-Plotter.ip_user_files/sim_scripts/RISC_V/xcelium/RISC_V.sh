...
#
# Script generated by Vivado on Fri Dec 12 11:58:06 CET 2025
...
#
# Usage        : RISC_V.sh
#                RISC_V.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RISC_V.sh [-reset_run]
#                RISC_V.sh [-reset_log]
#                RISC_V.sh [-help]
#
...
#                script (type 'RISC_V.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname microblaze_v11_0_15 -libname microblaze_riscv_v1_0_5 -libname xil_defaultlib -libname lmb_v10_v3_0_15 -libname lmb_bram_if_cntlr_v4_0_26 -libname blk_mem_gen_v8_4_11 -libname axi_lite_ipif_v3_0_4 -libname mdm_riscv_v1_0_5 -libname proc_sys_reset_v5_0_17 -libname interrupt_control_v3_1_5 -libname axi_gpio_v2_0_37 -libname axi_uartlite_v2_0_39 -libname xlconstant_v1_1_10 -libname smartconnect_v1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_35 -libname axi_vip_v1_1_21 -libname util_vector_logic_v2_0_5 -libname axi_bram_ctrl_v4_1_13 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm microblaze_v11_0_15 microblaze_riscv_v1_0_5 xil_defaultlib lmb_v10_v3_0_15 lmb_bram_if_cntlr_v4_0_26 blk_mem_gen_v8_4_11 axi_lite_ipif_v3_0_4 mdm_riscv_v1_0_5 proc_sys_reset_v5_0_17 interrupt_control_v3_1_5 axi_gpio_v2_0_37 axi_uartlite_v2_0_39 xlconstant_v1_1_10 smartconnect_v1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_35 axi_vip_v1_1_21 util_vector_logic_v2_0_5 axi_bram_ctrl_v4_1_13)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "RISC_V.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RISC_V.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a9be" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/f0b6/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a8e4/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/ec67/hdl" +incdir+"../../../../../../../apps/Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/maartenvk/apps/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a9be" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/f0b6/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a8e4/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/ec67/hdl" +incdir+"../../../../../../../apps/Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/maartenvk/apps/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_11 $xmvlog_opts +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a9be" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/f0b6/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a8e4/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/ec67/hdl" +incdir+"../../../../../../../apps/Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/maartenvk/apps/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  "../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a32c/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a9be" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/f0b6/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a8e4/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/ec67/hdl" +incdir+"../../../../../../../apps/Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/maartenvk/apps/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xlconstant_v1_1_10 $xmvlog_opts +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a9be" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/f0b6/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a8e4/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/ec67/hdl" +incdir+"../../../../../../../apps/Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/maartenvk/apps/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work smartconnect_v1_0 $xmvlog_opts -sv +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a9be" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/f0b6/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a8e4/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/ec67/hdl" +incdir+"../../../../../../../apps/Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/maartenvk/apps/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a9be" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/f0b6/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a8e4/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/ec67/hdl" +incdir+"../../../../../../../apps/Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/maartenvk/apps/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a9be" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/f0b6/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a8e4/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/ec67/hdl" +incdir+"../../../../../../../apps/Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/maartenvk/apps/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  "../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_35 $xmvlog_opts +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a9be" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/f0b6/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a8e4/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/ec67/hdl" +incdir+"../../../../../../../apps/Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/maartenvk/apps/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  "../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/c5b7/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_21 $xmvlog_opts -sv +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a9be" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/f0b6/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a8e4/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/ec67/hdl" +incdir+"../../../../../../../apps/Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/maartenvk/apps/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
  ...
  xmvlog -work util_vector_logic_v2_0_5 $xmvlog_opts +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a9be" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/f0b6/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/a8e4/hdl/verilog" +incdir+"../../../../KBSCE-Plotter.gen/sources_1/bd/RISC_V/ipshared/ec67/hdl" +incdir+"../../../../../../../apps/Xilinx/2025.1/data/rsb/busdef" +incdir+"/home/maartenvk/apps/Xilinx/2025.1/Vivado/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.RISC_V xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.RISC_V -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/maartenvk/src/KBSCE-Plotter/Vivado/KBSCE-Plotter.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log RISC_V_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RISC_V.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RISC_V.sh [-help]\n\
Usage: RISC_V.sh [-step]\n\
Usage: RISC_V.sh [-lib_map_path]\n\
Usage: RISC_V.sh [-reset_run]\n\
Usage: RISC_V.sh [-reset_log]\n\
Usage: RISC_V.sh [-keep_index]\n\
Usage: RISC_V.sh [-noclean_files]\n\n\
