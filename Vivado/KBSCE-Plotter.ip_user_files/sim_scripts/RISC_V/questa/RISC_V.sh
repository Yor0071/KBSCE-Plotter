...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
<<<<<<< HEAD
    lib_map_path="C:/Users/yoric/OneDrive/Documenten/GitHub/KBSCE-Plotter/Vivado/KBSCE-Plotter.cache/compile_simlib/questa"
=======
    lib_map_path="C:/Users/liamb/GitHub/KBSCE-Plotter/Vivado/KBSCE-Plotter.cache/compile_simlib/questa"
>>>>>>> camera_plotter_merge
  fi
