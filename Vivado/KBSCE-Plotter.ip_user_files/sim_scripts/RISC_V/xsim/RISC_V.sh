...
#
<<<<<<< HEAD
# Script generated by Vivado on Wed Dec 10 14:27:35 +0100 2025
=======
# Script generated by Vivado on Thu Dec 11 10:25:33 +0100 2025
...
simulate()
{
  xsim RISC_V -key {Behavioral:sim_1:Functional:RISC_V} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_33e2.protoinst" -protoinst "protoinst_files/RISC_V.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RISC_V.wdb xsim.dir libdpi.so)
